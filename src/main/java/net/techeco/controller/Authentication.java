...
public class Authentication {
    ...
    @RequestMapping(value = "Authenticate.htm", method = RequestMethod.POST, headers="Accept=*/*")
    @ResponseBody
    public String Login(HttpSession session, @RequestBody LoginCriteria account) {
        ...
        if(result) {
            ...
            try {
                node.set("userInfo", mapper.valueToTree(info));
